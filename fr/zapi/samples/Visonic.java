...
/**
 * Visonic
 * Envoi de commandes à un module 
 * 
 * 
 * @author Luc Doré
 *
 */
public class Visonic {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// ON
			zibase.sendCommand("B10", ZbAction.ON, ZbProtocol.VISONIC433);
			// wait 2 secondes
			Thread.sleep(1000*2);
			// OFF
			zibase.sendCommand("B10", ZbAction.OFF, ZbProtocol.VISONIC433);
